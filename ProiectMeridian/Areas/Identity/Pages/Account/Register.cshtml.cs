...
namespace ProiectMeridian.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            ProiectMeridian.Data.ProiectMeridianContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
           ...
           _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            ...
            Client.Email = Input.Email; _context.Client.Add(Client);
